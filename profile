...
:me a foaf:Person;
    ...
    foaf:gender "male"@en;
    foaf:img <https://sven-lieber.org/content/uploads/2017/04/me.jpg>;
    ...
    <http://dbpedia.org/ontology/orcidId> "0000-0002-7304-3787";
...
dbpedia:Uni_Freiburg a org:Organization, schema:CollegeOrUniversity;
        rdfs:label "University Freiburg"@en, "Albert Ludwigs UniversitÃ¤t Freiburg"@de;
